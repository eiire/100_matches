...
build/main.o: src/main.c
	gcc -Wall -Werror -c src/main.c -o build/main.o -lncurses

build/matches.o: src/matches.c
	gcc -Wall -Werror -c src/matches.c -o build/matches.o -lncurses
...
build/test.o: test/test.c
	gcc -Wall -Werror -c  test/test.c -o build/test.o -Ithirdparty -Isrc -lncurses

build/ctest.o: test/ctest.c
	gcc -Wall -Werror -c test/ctest.c -o build/ctest.o -Ithirdparty -lncurses
